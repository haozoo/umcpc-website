  ...
  return (
    <div className="h-[80] sm:h-screen flex flex-col 2xl:flex-row">
      <div className="mb-16 2xl:w-2/5">
        ...
        <p className="text-font text-left sm:text-justify mt-12 2xl:w-5/6">
        ...
        <p className="text-font text-left sm:text-justify mt-8 2xl:w-5/6">
        ...
        <p className="text-font mt-8 2xl:w-5/6">
          Scroll through our committee members and hover/click over each to get
          to know them better!
        </p>
      </div>
